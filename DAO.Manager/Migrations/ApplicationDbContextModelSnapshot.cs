...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAO.Manager.Models.Assembly", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAO.Manager.Models.AssemblyReference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAO.Manager.Models.ProjectDependency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAO.Manager.Models.Solution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAO.Manager.Models.SolutionProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAO.Manager.Models.Assembly", b =>
                {
                    b.HasOne("DAO.Manager.Models.Project", "Project")
                        .WithMany("Assemblies")
            ...
            modelBuilder.Entity("DAO.Manager.Models.AssemblyDependency", b =>
                {
                    ...
                    b.HasOne("DAO.Manager.Models.Assembly", "TargetAssembly")
            ...
            modelBuilder.Entity("DAO.Manager.Models.ProjectDependency", b =>
                {
                    ...
                    b.HasOne("DAO.Manager.Models.Project", "SourceProject")
                        .WithMany("DependenciesFrom")
